...
public class AppUtil {
    ...
    static {
        ...
        ALLOWED_CONTENT_TYPES.put(MODULE.DOCUMENT, Collections.singletonList("pdf"));
        ALLOWED_CONTENT_TYPES.put(MODULE.SPECIES, Collections.emptyList());
    ...
    public static List<MyUpload> parseZipFiles(String storageBasePath, String filePath, MODULE module) {
        ...
        try {
            ...
            while (it.hasNext()) {
                ...
                boolean allowedType = ALLOWED_CONTENT_TYPES.get(module).stream().anyMatch((type) -> contentType.toLowerCase().startsWith(type)
    ...
    public static boolean filterFileTypeForModule(String contentType, MODULE module) {
        ...
        addToList = ALLOWED_CONTENT_TYPES.get(module).stream().anyMatch(type -> contentType.toLowerCase().startsWith(type) || contentType.toLowerCase().endsWith(type));
        return addToList;
    }
    ...
    public static String getDatePrefix() {
        ...
        return sdf.format(new Date()) + "_" + new GregorianCalendar().get(Calendar.YEAR) +
                "_";
    }
    ...
    public static String generateCommand(String filePath, Integer w, Integer h, String format, Integer quality,
        ...
        if (fileName.contains(" ")) {
            command.append("'").append(fileName).append("-mod").append("_").append(w).append("x").append(h).append(".")
                    .append(format).append("'");
        } else {
            command.append(fileName).append("-mod").append("_").append(w).append("x").append(h).append(".").append(format);
        }
